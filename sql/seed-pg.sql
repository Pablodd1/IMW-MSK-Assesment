...
INSERT INTO exercise_library (name, category, body_region, description, instructions, difficulty, default_sets, default_reps, default_hold_time, default_frequency, indications, contraindications, targeted_deficiencies) VALUES
...
INSERT INTO clinicians (email, password_hash, first_name, last_name, title, license_number, license_state, npi_number, role, salt) VALUES
('demo@physioai.com', '$2a$10$demo_hash_would_go_here', 'Demo', 'Clinician', 'DPT', 'PT12345', 'CA', '1234567890', 'admin', 'physiomotion-salt-2025');
